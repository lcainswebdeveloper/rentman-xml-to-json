...
class PropertyDecorator
{
    ...
    public function decorate(array $amenityOptions = [], array $areaOptions = [])
    {
        ...
        $this->transformed['map'] = fullFilePath($this->propertyData['Map']);
        $this->transformed['floorplan'] = fullFilePath($this->propertyData['Floorplan']);
        ...
        $this->transformed['epc'] = fullFilePath($this->propertyData['Epc']);
